...
def manage_students():
    # your code here
    student_list = ['Kyle', 'Lauryn', 'Emma', "Helios"]
...
def combine_foods():
    # your code here
    foods = ('Teriyaki Chicken', 'French Fries', "Buffalo Chicken Stromboli", "Rice")
    meal = [n for n in foods]
    return meal
...
def list_home_town_items():
    # your code here
    home_town_items = [f"{key}: {home_town[key]}" for key in home_town]
